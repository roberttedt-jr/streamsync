...
export default function OnboardingTutorial({ onComplete }: OnboardingTutorialProps) {
  ...
  const steps = [
    {
      icon: Radio,
      title: "Watch Parties de Twitch en Directo",
      description:
        "Comparte directos de Twitch con tu comunidad. Salas compartidas con presencia en tiempo real y chat integrado.",
      badge: "Paso 1 de 3",
      accent: "from-violet-500 to-indigo-500",
    },
    {
      icon: Mic,
      title: "Voz y Cámara Opcionales con Turnos",
      description:
        "Habla con tu comunidad con voz y cámara opcionales, activadas únicamente tras tu autorización explícita y con sistema de turnos.",
      badge: "Paso 2 de 3",
      accent: "from-cyan-500 to-blue-500",
    },
    {
      icon: Users,
      title: "Tus Canales de Twitch Vinculados",
      description:
        "Inicia sesión con Twitch para sincronizar los canales a los que sigues y abrir Watch Parties compartidas con un solo clic.",
      badge: "Paso 3 de 3",

            ...
            <p className="text-gray-400 text-xs max-w-sm leading-relaxed">
              {t?.footer?.description ||
                (language === "en"
                  ...
                  : "La plataforma definitiva para disfrutar de directos de Twitch sincronizados al milisegundo con amigos, chat de voz ultrarrápido y overlay de estadísticas.")}
            </p>

...
function AuthFormContent() {
  ...
  // Show toast if redirected back with an error param
                  ...
                  <button
                    ...
                    title={
                      providersStatus.twitch
                        ...
                        : "Pendiente: Configura TWITCH_CLIENT_ID y TWITCH_CLIENT_SECRET en Vercel"
                    }
                  >
                    {redirectingProvider === "twitch" ? (
                      <>
                        <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin shrink-0" />
                        <span>Redirigiendo a Twitch...</span>
                      </>
                    ) : (
                      <>

...
export default function ProfilePage() {
  ...
  // Mock list of Twitch followed channels for demonstration
  const [twitchChannels, setTwitchChannels] = useState([
    { name: "valorant", game: "VALORANT", viewers: "45K", live: true },
    { name: "eslcs", game: "Counter-Strike 2", viewers: "38K", live: true },
    { name: "rocketleague", game: "Rocket League", viewers: "22K", live: true },
    { name: "elxokas", game: "Gaming / Variedad", viewers: "28K", live: false },
    { name: "auronplay", game: "Minecraft", viewers: "35K", live: false },
    { name: "midudev", game: "Software & Web", viewers: "5K", live: true },
  ]);
  const [newTwitchChannel, setNewTwitchChannel] = useState("");

  // Mock list of YouTube subscriptions
  const [ytSubscriptions, setYtSubscriptions] = useState([
    { title: "Lofi Girl", handle: "@LofiGirl", live: true, videoId: "jfKfPfyJRdk" },
    { title: "Synthwave Boy", handle: "@SynthwaveBoy", live: true, videoId: "4xDzrJKXOOY" },
    { title: "GameSpot", handle: "@GameSpot", live: true, videoId: "0qL3w2eG6Jk" },
    { title: "IGN", handle: "@IGN", live: false, videoId: "dQw4w9WgXcQ" },
  ]);
  ...
  const [history] = useState([
    {
      id: "hist_1",
      roomName: "VCT Masters Grand Final Watch Party",
      platform: "twitch" as const,
      channel: "valorant",
      date: "Hoy, hace 2 horas",
      duration: "1h 45m",
      participants: 18,
    },
    {
      id: "hist_2",
      roomName: "Lofi Coding Session nocturna",
    ...
    {
      id: "hist_3",
      roomName: "CS2 Major Finals en Directo",
      platform: "twitch" as const,
      channel: "eslcs",
      date: "Hace 3 días",
      duration: "2h 20m",
  ...
  const handleAddTwitchChannel = (e: React.FormEvent) => {
    ...
    setTwitchChannels((prev) => [
      ...prev,
      { name: clean, game: "Gaming", viewers: "Live", live: true },
    ]);
    setNewTwitchChannel("");
  ...
  const handleAddYtChannel = (e: React.FormEvent) => {
    ...
    setYtSubscriptions((prev) => [
      ...prev,
      { title: clean, handle: `@${clean}`, live: true, videoId: "jfKfPfyJRdk" },
    ]);
    setNewYtChannel("");
    addToast(`Canal ${clean} añadido a suscripciones`, "success");
  };

  const handleLaunchRoom = (channel: string, platform: "twitch" | "youtube") => {
    const code = `user-${Math.random().toString(36).substring(2, 7)}`;
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-purple-950/40 via-purple-900/20 to-cyan-950/30 p-6 sm:p-8 backdrop-blur-xl shadow-2xl">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 relative z-10">
            {/* Avatar */}
            <div className="relative w-24 h-24 sm:w-28 sm:s-28 rounded-3xl overflow-hidden bg-white/10 border-2 border-purple-500/40 shadow-2xl flex items-center justify-center shrink-0">
              {user?.avatar ? (
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="text-xs sm:text-sm text-gray-300 mt-2 max-w-xl">
                {user?.bio || "Fanático de las watch parties en tiempo real y el gaming competitivo con amigos."}
              </p>
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-2 border-b border-white/10">
          ...
          >
            ...
            <span>Suscripciones de YouTube</span>
          </button>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h3 className="text-lg font-bold text-white flex items-center gap-2">
                  ...
                  <span>Tus Streamers de Twitch</span>
                </h3>
                <p className="text-xs text-gray-400">
                  Lanza una watch party instantánea con cualquiera de tus streamers seguidos.
                </p>
              </div>
              ...
              {twitchChannels.map((item, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {item.live && (
                          <span className="flex items-center gap-1 text-[10px] font-bold text-emerald-400 bg-emerald-500/20 px-1.5 py-0.2 rounded">
                  ...
                  <button
                    ...
                    title="Iniciar Watch Party con este streamer"
                  >
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-gray-400">
                  Transmite vídeos o directos de tus canales favoritos de YouTube.
                </p>
              </div>
              ...
              <form onSubmit={handleAddYtChannel} className="flex items-center gap-2">
                <input
                  type="text"
                  placeholder="Nombre de canal o ID..."
                  value={newYtChannel}
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-gray-400 truncate">{item.handle}</p>
                    </div>
                  </div>

                  <button
                    onClick={() => handleLaunchRoom(item.videoId, "youtube")}
                    className="p-2 rounded-xl bg-white/5 hover:bg-[#FF0000] text-gray-300 hover:text-white transition cursor-pointer"
                    title="Iniciar Watch Party con este vídeo"
                  >
                    <Play className="w-4 h-4 fill-current" />
                  </button>
                </div>
        ...
        {activeTab === "history" && (
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-white flex items-center gap-2">
              ...
              <span>Historial de Salas Visitadas</span>
            </h3>
              ...
              {history.map((hist) => (
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-400">
                      Canal: <span className="text-purple-300">{hist.channel}</span> • Duración: {hist.duration} • {hist.participants} participantes
                    </p>
                  </div>

                  <div className="flex items-center gap-3">
                    <span className="text-xs text-gray-500 font-mono">{hist.date}</span>
                    <button
                      onClick={() => handleLaunchRoom(hist.channel, hist.platform)}
                      className="liquid-btn-primary px-3 py-1.5 rounded-xl text-xs font-bold cursor-pointer"
                    >
                      Reabrir sala
                    </button>
                  </div>
        ...
        {activeTab === "stats" && (
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-white flex items-center gap-2">
              ...
              <span>Tus Estadísticas de Usuario</span>
            </h3>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="glass-panel p-5 rounded-3xl border border-white/10 text-center">
                <Clock className="w-8 h-8 text-purple-400 mx-auto mb-2" />
                <span className="text-3xl font-black text-white">{user?.statsHoursWatched || 2.4}h</span>
              ...
              <div className="glass-panel p-5 rounded-3xl border border-white/10 text-center">
                ...
                <span className="text-3xl font-black text-white">{user?.statsRoomsJoined || 1}</span>
              ...
              <div className="glass-panel p-5 rounded-3xl border border-white/10 text-center">
                ...
                <p className="text-xs text-gray-400 uppercase font-semibold mt-1">Latencia Media</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="max-w-2xl">
            <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/10 space-y-6">
              <div>
                ...
                <p className="text-xs text-gray-400">
                  Personaliza tu nombre público, foto de perfil y cuentas vinculadas.
                </p>
              </div>
              ...
              <form onSubmit={handleSaveSettings} className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[11px] text-gray-400 mb-2">
                      Sube cualquier fotografía desde tu dispositivo local (PNG, JPG, WebP).
                    </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-gray-300 mb-1">Canal de Twitch</label>
                    <input
                      type="text"
